...
7. Use grep for structural/pattern searches (imports, function signatures) and search_code for simple text lookups.
 ...
 */
export async function runAgentLoop({ history, files, model, onEvent, signal }) {
