...
export const toolDefinitions = [
  ...
  },
  {
    ...
    function: {
      name: "make_plan",
      description:
        "Produce a structured step-by-step execution plan when a task is large or ambiguous and a visible plan is useful. Do not call this tool for simple fixes just to create an extra round trip.",
      parameters: {
        type: "object",
        properties: {
  ...
  },
  {
    ...
    function: {
      ...
      parameters: {
        type: "object",
        properties: {
          text: { type: "string", description: "The fact/decision/convention to remember, one sentence." },
          category: {
            type: "string",
            enum: ["convention", "decision", "constraint", "preference", "note"],
