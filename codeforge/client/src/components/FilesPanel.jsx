...
import { FolderTree, Code2, Eye, X, TerminalSquare, PanelRightClose } from "lucide-react";
...
export default function FilesPanel({ open, onClose, isMobile, mobileVisible }) {
  const { files, activeFile, openFileTab, openFiles, closeFileTab, terminalOpen, setTerminalOpen, terminalLog, chatId } =
    useApp();
