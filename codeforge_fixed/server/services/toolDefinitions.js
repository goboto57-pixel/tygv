...
export const toolDefinitions = [
  ...
  { type: "function", function: { name: "web_search", description: "Search the live web for current info (docs, prices, news) and get a synthesized answer with sources. Use when you need something that may have changed since training or that you don't know.", parameters: { type: "object", properties: { query: { type: "string" }, premium: { type: "boolean", description: "Use higher-rate-limit premium search." } }, required: ["query"] } } },
  ...
  { type: "function", function: { name: "analyze_bundle", description: "Analyze bundle size by extension.", parameters: { type: "object", properties: {}, required: [] } } },
